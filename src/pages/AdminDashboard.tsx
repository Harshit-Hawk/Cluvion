        ...
        <div className="flex flex-col gap-6">
          ...
          >
            ...
            <div className="space-y-3 relative z-10">
              <Link href="/admin/clubs" className="flex items-center justify-between bg-white/10 hover:bg-white/20 p-3 rounded-xl backdrop-blur-sm border border-white/5 transition-colors group/btn">
              ...
              <Link href="/admin/users" className="flex items-center justify-between bg-white/10 hover:bg-white/20 p-3 rounded-xl backdrop-blur-sm border border-white/5 transition-colors group/btn">
                <div className="flex items-center gap-3">
